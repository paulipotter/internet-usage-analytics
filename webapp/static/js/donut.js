            ...
            var eventObj = {
                ...
                'mouseover': function(d, i, j) {
                    ...
                    thisDonut.select('.value').text(function(donut_d) {
                        return d.data.cat + ": " +d.data.val + donut_d.unit;
                    });
...
function genData2() {
    ...
    {
        var data2 = new Array();
        //console.log(key + " " + donuts[key].length)
        for( var i = 0; i < donuts[key].length;i++)
        {
            data2.push({
                "cat":donuts[key][i]['label'],
                "val":donuts[key][i]['count']
            });
